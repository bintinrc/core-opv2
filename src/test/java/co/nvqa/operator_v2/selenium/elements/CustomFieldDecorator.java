...
public class CustomFieldDecorator extends DefaultFieldDecorator
{
    ...
    public CustomFieldDecorator(WebDriver webDriver, SearchContext searchContext, Class<?> genericType)
    {
    ...
    protected Class<?> getDecoratableClassForList(Field field)
    {
        ...
        Class<?> clazz = this.genericType != null ? this.genericType : TypeToken.of(listType).getRawType();
    ...
    @SuppressWarnings("unchecked")
    protected <T> List<T> proxyForListElements(ClassLoader loader, ElementLocator locator, Class<T> clazz)
    {
    ...
    private <T> T createInstance(Class<T> clazz, WebElement element, Class<?> genericType)
    {
        try
        {
            ...
            {
                return clazz.getConstructor(WebDriver.class, WebElement.class, Class.class).newInstance(webDriver, element, genericType);
            } else
            {
