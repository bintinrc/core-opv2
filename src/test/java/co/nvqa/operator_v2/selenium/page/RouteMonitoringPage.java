...
public class RouteMonitoringPage extends OperatorV2SimplePage {
  ...
  public void verifyRouteIsExistAndHasCorrectInfo(long routeId,
      RouteMonitoringFilters routeMonitoringFilters) {
  ...
  public void verifyRouteMonitoringParams(RouteMonitoringParams expectedRouteMonitoringParams) {
    ...
    RouteMonitoringParams actualRouteMonitoringParams = routeMonitoringTable
