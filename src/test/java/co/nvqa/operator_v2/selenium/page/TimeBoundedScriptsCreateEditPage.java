...
public class TimeBoundedScriptsCreateEditPage extends OperatorV2SimplePage {
  ...
  public void createAndReleaseTimeBoundedScript(Script parentScript, Script script,
    ...
    waitUntilPageLoaded(
        String.format("pricing-scripts-v2/%s/create?type=time_inbounded", parentScript.getId()));
    ...
    waitUntil(() ->
        {
          ...
          NvLogger.infof(
              "TimeBoundedScriptsCreateEditPage.waitUntilPageLoaded: Current URL = [%s] - Expected URL contains = [%s]",
