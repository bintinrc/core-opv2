...
public class ShipperBillingPage extends OperatorV2SimplePage
{
    ...
    public static class ReviewDetailsView extends OperatorV2SimplePage
    {
        ...
        private static final String SHIPPER_ID_LOCATOR = CARD_LOCATOR + "//md-input-container[@name='commons.shipper-id']/div";
        private static final String SHIPPER_NAME_LOCATOR = CARD_LOCATOR + "//md-input-container[@name='commons.model.shipper-name']/div";
        private static final String TYPE_LOCATOR = CARD_LOCATOR + "//md-input-container[@name='container.shipper-billing.review-deduct-add']/div";
        private static final String AMOUNT_LOCATOR = CARD_LOCATOR + "//md-input-container[@name='commons.amount']/div";
        private static final String REASON_LOCATOR = CARD_LOCATOR + "//md-input-container[@name='commons.reason']/div";
        private static final String SUBMIT_BUTTON_LOCATOR = CARD_LOCATOR + "//nv-api-text-button[@name='commons.submit']/button";
