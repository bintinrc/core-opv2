...
public class PrinterTemplatesPage extends OperatorV2SimplePage
{
    ...
    public void verifyTemplateIsLoadedAndAllNeededFieldsIsShownOnRightPanel()
    {
        ...
        while(matcher.find())
        {
            ...
            if(expectedField.equals("tracking_id")) // I don't know why tracking_id became quantity. This is based on the source code that Rizaq show to me.
            {
        ...
        {
            assertTrue(f("Field '%s' not found.", expectedField), isElementExist(f("//div[./h5[text()='Fields']]/following-sibling::div//label[text()='%s']", expectedField)));
        }
    }
}
