...
public class ZonesPage extends OperatorV2SimplePage {
  ...
  public void waitUntilPageLoaded() {
    ...
    waitUntilInvisibilityOfElementLocated(
        "//md-progress-circular/following-sibling::div[text()='Loading zones...']");
  }
  ...
  public void fillTheForm(Zone zone) {
    ...
    selectValueFromMdSelectMenu("//md-input-container[@label='commons.hub']", String
        .format("//md-option/div[@class='md-text'][contains(text(), '%s')]", zone.getHubName()));
    ...
    retryIfRuntimeExceptionOccurred(() ->
    {
      ...
      if (isTableEmpty()) {
        throw new NvTestRuntimeException(
            f("Zone with name = '%s' not found. Zones table is empty.", name));
      }
    });
  }
