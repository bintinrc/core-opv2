...
public class CodReportPage extends OperatorV2SimplePage
{
    ...
    public static final String COLUMN_CLASS_GRANULAR_STATUS = "granular_status";
    public static final String COLUMN_CLASS_SHIPPER_NAME = "shipper_name";
    public static final String COLUMN_CLASS_GOODS_AMOUNT = "goods_amount";
    ...
    public void verifyOrderIsExistWithCorrectInfo(Order order)
    {
        ...
        String actualTrackingId = getTextOnTable(indexOfOrderInTable, COLUMN_CLASS_TRACKING_ID);
        String actualGranularStatus = getTextOnTable(indexOfOrderInTable, COLUMN_CLASS_GRANULAR_STATUS);
        String actualShipperName = getTextOnTable(indexOfOrderInTable, COLUMN_CLASS_SHIPPER_NAME);
        Double actualGoodsAmount = Double.parseDouble(getTextOnTable(indexOfOrderInTable, COLUMN_CLASS_GOODS_AMOUNT));
    ...
    {
        List<WebElement> listOfTrackingIdsWe = findElementsByXpath(String.format("//tr[@ng-repeat='%s']/td[contains(@class,'%s')]", NG_REPEAT, COLUMN_CLASS_TRACKING_ID));
        int indexResult = 0;
        int indexCounter = 0;
