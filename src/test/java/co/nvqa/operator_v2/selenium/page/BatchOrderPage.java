...
public class BatchOrderPage extends OperatorV2SimplePage
{
    ...
    public void verifyOrderInfoOnTableOrderIsCorrect(Order order)
    {
        ...
        String expectedFrom = order.getFromName()+System.lineSeparator()+order.getFromAddress1()+" "+order.getFromAddress2()+" "+order.getFromCountry()+" "+order.getFromPostcode();
        expectedFrom = expectedFrom.replaceAll("( )+", " ");
        String expectedTo = order.getToName()+System.lineSeparator()+order.getToAddress1()+" "+order.getToAddress2()+" "+order.getToCountry()+" "+order.getToPostcode();
