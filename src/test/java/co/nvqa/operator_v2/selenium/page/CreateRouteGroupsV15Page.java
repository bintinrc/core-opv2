...
public class CreateRouteGroupsV15Page extends OperatorV2SimplePage {
  ...
  @FindBy(css = "nv-filter-box[item-types='Service Level']")
  public NvFilterBox serviceLevelFilter;
  ...
  public CreateRouteGroupsV15Page(WebDriver webDriver) {
    super(webDriver);
    ...
    filters = ImmutableMap.<String, AbstractFilterBox>builder()
        ...
        .put("Service Level", serviceLevelFilter)
        .put("Excluded Shipper", excludedShipperFilter)
        .put("Hub Inbound Datetime", hubInboundDateTimeFilter)
        .put("Hub Inbound User", hubInboundUserFilter)
        .put("Orig Trxn End Time", origTrxnEndTimeFilter)
        .build();
  }
