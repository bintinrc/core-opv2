...
public class SortBeltManagerPage extends OperatorV2SimplePage
{
    ...
    public void verifyDuplicateConfigIsExistAndDataIsCorrect(String armOutput,String destinationHubs,String orderTags)
    {
        find.sendKeys(armOutput);
        assertThat("Arm Output", actualDuplicateArmOutput.getText(), equalToIgnoringCase(armOutput));
        assertThat("Destination Hub", actualDuplicateDestinationHub.getText(), equalToIgnoringCase(destinationHubs));
