...
public class ShipmentLinehaulPage extends OperatorV2SimplePage {
  ...
  public void fillLinehaulNameFT(String name) {
    retryIfStaleElementReferenceExceptionOccurred(() -> sendKeys(XPATH_LINEHAUL_NAME_TF, name),
        "fillLinehaulNameFT");
  }
  ...
  public void clickEditLinehaulAtDate(String linehaulId) {
    click(getXpathLinehaulInfoOnSchedule(linehaulId)
        + "/div/nv-icon-text-button/button[@aria-label='edit linehaul']");
  }
  ...
  public void waitUntilLinehaulDateTabIsLoaded() {
    waitUntilInvisibilityOfElementLocated(
        "//md-progress-circular/parent::*[@style='display: inherit;']");
  }
}
