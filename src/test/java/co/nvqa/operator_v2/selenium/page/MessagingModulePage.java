...
public class MessagingModulePage extends OperatorV2SimplePage {
  ...
  public void continueOnCsvUploadFailure() {
    ...
    waitUntilVisibilityOfElementLocated(
        "//md-dialog[contains(@class,'nv-partial-failed-upload-csv')]");
  ...
  public void composeSms(String name, String trackingId) {
    ...
    String actualMessage = findElementByXpath(
        "//md-input-container[@model='ctrl.messagePreview']/textarea[@name='preview']")
        .getAttribute("value");
  ...
  public void verifySmsHistoryTrackingIdValid(String trackingId, String contactNumber) {
    ...
    WebElement trackingIdElement = findElementByXpath(
        "//md-card[contains(@class,'sms-history')]/md-card-content/div/span");
