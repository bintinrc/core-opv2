...
public class PortTripManagementPage extends OperatorV2SimplePage {
  ...
  public PortTripManagementPage(WebDriver webDriver) {
    super(webDriver);
//        airportTable = new PortTripManagementPage.AirportTable(webDriver);
...
//    }
//
//    public void createNewPortTrip(Map<String, String> mapOfData) {
...
//        }
//    }
//    public void verifyPortTripCreationSuccessMessage(String message) {
//        retryIfAssertionErrorOrRuntimeExceptionOccurred(()->{
//            String actMessage = getAntTopText();
...
//                        .put(PortTable.COLUMN_MAWB, "mawb")
...
//                            PortTable.ACTION_DELETE, "delete-trip-icon",
//                            PortTable.ACTION_ASSIGN_DRIVER, "assign-driver-icon",
