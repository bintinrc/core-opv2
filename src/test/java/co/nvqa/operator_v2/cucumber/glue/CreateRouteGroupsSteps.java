...
public class CreateRouteGroupsSteps extends AbstractSteps {
  ...
  public void operatorVerifyTransactionReservationRecordOnCreateRouteGroupPageUsingDataBelow(
      String type, Map<String, String> mapOfData) throws ParseException {
    ...
    if (StringUtils.equalsIgnoreCase(value, "GET_FROM_CREATED_ORDER")) {
      String address = StringUtils.normalizeSpace(StringUtils.join(ImmutableList
              .of(transaction.getAddress1(), transaction.getAddress2(), transaction.getPostcode()),
          " "));
