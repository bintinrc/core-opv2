...
public class OrderCreationV2Steps extends AbstractSteps {
  ...
  public void operatorCreateOrderV2ByUploadingCsvOnOrderCreationV2PageUsingDataBelow(
      DataTable dataTable) {
  ...
  public void operatorCreateOrderV3ByUploadingCsvOnOrderCreationV2PageUsingDataBelow(
      DataTable dataTable) {
    operatorCreateOrderByUploadingCsvOnOrderCreationV2PageUsingDataBelow(dataTable);
  }

  private void operatorCreateOrderByUploadingCsvOnOrderCreationV2PageUsingDataBelow(
      DataTable dataTable) {
