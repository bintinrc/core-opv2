...
public class ReservationRejectionSteps extends AbstractSteps {
  ...
  public void operatorVerifiesTheReservationIsListedOnTheTableWithCorrectInformation() {
    ...
    String pickupInfo =
        address.getAddress1() + address2 + " " + address.getCountry() + " " + address.getPostcode();
    ...
    reservationRejectionPage
        .validateReservationInTable(pickupInfo, rejectReservationRequest, entity);
  }
