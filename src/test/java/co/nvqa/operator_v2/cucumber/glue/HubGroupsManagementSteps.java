...
public class HubGroupsManagementSteps extends AbstractSteps {
  ...
  public void operatorCreateNewHubGroupOnHubGroupsManagementPageUsingDataBelow(
  ...
  public void operatorUpdateCreatedHubGroupOnHubsGroupManagementPageUsingDataBelow(
      Map<String, String> mapOfData) {
    HubsGroup hubsGroup = get(KEY_CREATED_HUBS_GROUP);
