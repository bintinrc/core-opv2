...
public class ShipmentGlobalInboundSteps extends AbstractSteps {
  ...
  public void operatorChangeTheDataOfTheCreatedTrackingIDWithThisData(
  ...
  public void operatorVerifiesPriorityLevelInShipmentGlobalInboundInfoIsCorrectUsingDataBelow(
      Map<String, String> mapOfData) {
    ...
    shipmentGlobalInboundPage
        .verifiesPriorityLevelInfoIsCorrect(expectedPriorityLevel, expectedPriorityLevelColor);
  }
