...
import co.nvqa.operator_v2.api.client.order_create.OrderCreateV3Client;
import co.nvqa.operator_v2.model.order_creation.authentication.AuthRequest;
import co.nvqa.operator_v2.support.*;
import com.google.inject.Inject;
import co.nvqa.operator_v2.api.client.order_create.OrderCreateV2Client;
...
public class CommonShipperSteps extends AbstractSteps
{
    ...
    List<co.nvqa.operator_v2.model.order_creation.v3.CreateOrderRequest> createOrderRequests = new ArrayList<>();
    List<co.nvqa.operator_v2.model.order_creation.v3.CreateOrderResponse> createOrderResponses = new ArrayList<>();
    ...
    public void shipperCreateV2Order(DataTable dataTable) throws IOException
    {
        ...
        co.nvqa.operator_v2.model.order_creation.v2.CreateOrderRequest createOrderRequest = JsonHelper.fromJson(v2OrderRequestJson, co.nvqa.operator_v2.model.order_creation.v2.CreateOrderRequest.class);
        String suffix = "";
        ...
        List<co.nvqa.operator_v2.model.order_creation.v2.CreateOrderResponse> listOfCreateOrderResponse = CommonUtil.retryIfAssertionErrorOrRuntimeExceptionOccurred(()->orderCreateV2Client.createOrder(createOrderRequest), "createV2Order", getScenarioManager()::writeToScenarioLog);
    ...
    private String createV3Order(Map<String, String> arg1) throws Throwable
    {
        ...
        co.nvqa.operator_v2.model.order_creation.v3.CreateOrderRequest x = JsonHelper.mapToObject(arg1, co.nvqa.operator_v2.model.order_creation.v3.CreateOrderRequest.class);
        //-- fix keywords
    ...
    private void sendOrderCreateV3Req(Map<String, String> arg1) throws Throwable
    {
        ...
        createOrderResponses = JsonHelper.fromJsonCollection(json, List.class, co.nvqa.operator_v2.model.order_creation.v3.CreateOrderResponse.class);
        ...
        for(co.nvqa.operator_v2.model.order_creation.v3.CreateOrderResponse x : createOrderResponses)
        {
