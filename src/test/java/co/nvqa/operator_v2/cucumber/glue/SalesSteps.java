...
public class SalesSteps extends AbstractSteps
{
    ...
    public void operatorUploadCsvContainsMultipleSalesPersonsOnSalesPage(Map<String, String> dataTableAsMap)
    {
        List<SalesPerson> listOfSalesPerson = new ArrayList<>();
        int numberOfSalesPerson = Integer.parseInt(dataTableAsMap.getOrDefault("numberOfSalesPerson", "1"));
