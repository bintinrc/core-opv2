...
public class RouteCleaningReportSteps extends AbstractSteps {
  ...
  public void operatorVerifyTheCODInformationOnRouteCleaningReportPageByFollowingParameters(
  ...
  public void operatorDownloadCSVForTheNewCODOnRouteCleaningReportPage() {
    RouteCashInboundCod routeCashInboundCod = get(KEY_ROUTE_CASH_INBOUND_COD);
    routeCleaningReportPage.downloadCsvForSelectedCOD(
        Collections.singletonList(String.valueOf(routeCashInboundCod.getRouteId())));
  }
  ...
  public void operatorCollectCODInfoForTheRoute() {
    RouteCashInboundCod routeCashInboundCod = get(KEY_ROUTE_CASH_INBOUND_COD);
    routeCleaningReportPage.codTable()
        .filterByColumn(COLUMN_ROUTE_ID, String.valueOf(routeCashInboundCod.getRouteId()));
  ...
  public void operatorVerifyTheParcelInfoIsCorrectInDownloadedCSVFile() {
    ...
    routeCleaningReportPage
        .verifyDownloadedParcelCsvFileContent(Collections.singletonList(parcelInfo));
  }
  ...
  public void operatorVerifyTheParcelInfoForTheCreatedOrderIsCorrectOnRouteCleaningReportPageByFollowingParameters(
      Map<String, String> mapOfData) {
    Map<String, String> adjustedData = new HashMap<>(mapOfData);
