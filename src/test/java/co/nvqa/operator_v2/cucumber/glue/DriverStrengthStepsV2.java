...
public class DriverStrengthStepsV2 extends AbstractSteps
{
    ...
    public void operatorCreateNewDriverOnDriverStrengthPageUsingDataBelow(Map<String, String> mapOfData)
    {
    ...
    public void operatorVerifyDriverStrengthIsFilteredByDriverType(String expectedDriverType)
    {
        ...
        assertThat("Type values", actualDriverTypes, Matchers.everyItem(containsString(expectedDriverType)));
    }
