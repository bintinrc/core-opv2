...
public class PathManagementSteps extends AbstractSteps {
  ...
  public void operatorCreateManualPathWithFollowingData(Map<String, String> mapOfData) {
    ...
    if ("single".equals(selectSchedule)) {
      ...
      String departureTime = pathManagementPage.createManualPathModal.departureScheduleFirstInfo
          .getText().split(" ")[2];
    ...
    if ("multiple".equals(selectSchedule)) {
      ...
      String departureTime = pathManagementPage.createManualPathModal.departureScheduleFirstInfo
          .getText().split(" ")[2];
      String secondDepartureTime = pathManagementPage.createManualPathModal.departureScheduleSecondInfo
          .getText().split(" ")[2];
      putInList(KEY_LIST_MANUAL_PATH_DEPARTURE_TIMES, departureTime);
  ...
  public void operatorVerifyCreatedPathDataInPathDetailWithFollowingData(
  ...
  public void operatorVerifyCreatedManualPathWithScheduleDataInPathDetail(String scheduleNumber,
      Map<String, String> mapOfData) {
    Map<String, String> resolvedMapOfData = resolveKeyValues(mapOfData);
    String originHubName = resolvedMapOfData.get("originHubName");
    String destinationHubName = resolvedMapOfData.get("destinationHubName");
  ...
  public void operatorVerifiesPathDataAppearInPathTableWithFollowingHubs(
      Map<String, String> mapOfData) {
    Map<String, String> resolvedMapOfData = resolveKeyValues(mapOfData);
    String originHubName = resolvedMapOfData.get("originHubName");
    String destinationHubName = resolvedMapOfData.get("destinationHubName");
  ...
  public void operatorVerifyItCannotCreateManualPathWithoutSelectingSchedule(String reason,
      Map<String, String> mapOfData) {
    Map<String, String> resolvedMapOfData = resolveKeyValues(mapOfData);
  ...
  public void operatorCancelAddManualPathButtonAfterFillOriginAndDestinationHub(
    ...
    pathManagementPage.createManualPathModal.waitUntilVisible();
    pathManagementPage
        .createManualPathFirstStage(resolvedOriginHubName, resolvedDestinationHubName);
  ...
  public void operatorVerifyTransitHubInputEmptyAfterRetractOneStep(String originHubName,
  ...
  public void operatorVerifyNoPathFoundMessageIsShownInCreateDefaultPathModal(String originHub,
  ...
  public void operatorVerifyItCannotEditManualPathWithData(String reason,
      Map<String, String> mapOfData) {
