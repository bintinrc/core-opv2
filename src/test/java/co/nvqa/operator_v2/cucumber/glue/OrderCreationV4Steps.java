...
public class OrderCreationV4Steps extends AbstractSteps {
  ...
  @Inject
  private StandardApiShipperSteps standardApiShipperSteps;
  ...
  public void operatorCreateOrderVByUploadingXLSXOnOrderCreationVPageUsingDataBelow(
  ...
  public void operatorClickDownloadSampleFileButtonOnOrderCreationVIsPage() {
    orderCreationV4Page
        .clickNvIconTextButtonByNameAndWaitUntilDone("container.order.create.download-sample-file");
  }
  ...
  public void OperatorVerifyTheDownloadedCsvFileIsContainsTheCorrectValue(
      Map<String, String> dataTable) throws IOException {
