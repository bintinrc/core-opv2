...
#    And API Operator calls pending pickup job trigger for station
    ...
    Examples:
      ...
      | Search by Pickup Address | {hub-name-2} | {hub-id-2} | Vietnam | N+0 Pickup Rates | Pickup Address/ Address ID | Pendingpickup     | pickup            |
      | Search by Address ID     | {hub-name-2} | {hub-id-2} | Vietnam | N+0 Pickup Rates | Pickup Address/ Address ID | 1434303           | 303               |
      | Search by Shipper Name   | {hub-name-2} | {hub-id-2} | Vietnam | N+0 Pickup Rates | Shipper Name/ Shipper ID   | STATION-SHIPPER   | PPER              |
      | Search by Shipper ID     | {hub-name-2} | {hub-id-2} | Vietnam | N+0 Pickup Rates | Shipper Name/ Shipper ID   | 138               | 383               |
      | Search by Driver Name    | {hub-name-2} | {hub-id-2} | Vietnam | N+0 Pickup Rates | Driver Name/ Route ID      | STATION-DRIVER    | IVER              |
      | Search by Route ID       | {hub-name-2} | {hub-id-2} | Vietnam | N+0 Pickup Rates | Driver Name/ Route ID      | 65929             | 29                |
  ...
  Scenario Outline: Assign Pending Pickup Job to Route
    ...
    And API Shipper create V4 order using data below:
      | shipperClientId     | {station-vn-shipper-v4-client-id}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
      | shipperClientSecret | {station-vn-shipper-v4-client-secret}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
      | v4OrderRequest      | {"service_type":"Parcel","service_level":"Standard","reference":{"merchant_order_number":"ship-123","merchant_order_metadata":{"delivery_verification_identity":null}},"from":{"name":"TEST-NADIA-SHIPPER","phone_number":"+6591434259","address":{"address1":"Station Pendingpickup","address2":"","country":"VN","postcode":"018981","latitude":"8.88888","longitude":"8.88888"}},"to":{"name":"TEST-NADIA-CUSTOMER","phone_number":"+6591434259","email":"nadia.dwijaatmaja@ninjavan.co","address":{"address1":"JalanBidakaraMentengDalamTebet","address2":"NVQA","country":"VN","postcode":"12870"}},"parcel_job":{"allow_doorstep_dropoff":true,"enforce_delivery_verification":false,"delivery_verification_mode":"OTP","is_pickup_required":true,"pickup_date":"{gradle-current-date-yyyy-MM-dd}","cash_on_delivery":null,"pickup_timeslot":{"start_time":"09:00","end_time":"22:00","timezone":"Asia/Ho_Chi_Minh"},"pickup_instructions":"pickupinstruction","pickup_address":{"name":"TEST-NADIA-SHIPPER","phone_number":"+6591434259","address":{"address1":"Station Pendingpickup","address2":"","country":"VN","postcode":"018981","latitude":"8.88888","longitude":"8.88888"}},"delivery_start_date":"{{next-1-day-yyyy-MM-dd}}","delivery_timeslot":{"start_time":"09:00","end_time":"22:00","timezone":"Asia/Ho_Chi_Minh"},"delivery_instructions":"deliveryinstruction","dimensions":{"weight":1,"width":10,"height":10,"length":10,"size":"S"},"pickup_approximate_volume":"LargerthanVanLoad","experimental_from_international":false,"experimental_to_international":false}} |
    And Operator changes the country to "<Country>"
    And Operator verify operating country is "<Country>"
    And API Operator calls pending pickup job trigger for station
    And Operator go to menu Station Management Tool -> Station Management Homepage
