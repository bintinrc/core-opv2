...
Feature: Number of Parcels with Exception Cases
  ...
  Scenario Outline: Detail of <Status> Ticket Status (<hiptest-uid>)
    ...
    Examples:
      ...
      | SHIPPER ISSUE | DUPLICATE PARCEL | XMAS CAGE    | PENDING SHIPPER | Number of parcels with exception cases | Parcels with Exception Cases | uid:8352bc12-86e3-45f6-b680-e2dcd013fe01 |
  ...
  Scenario Outline: Detail of <Status> Ticket Status (<hiptest-uid>)
    ...
    Examples:
      ...
      | PARCEL ON HOLD | SHIPPER REQUEST | RESUME DELIVERY | PENDING SHIPPER | Number of parcels with exception cases | Parcels with Exception Cases | uid:0f9fb65f-ee58-4911-b08f-b87b0124687b |
  ...
  Scenario Outline: Detail of <Status> Ticket Status (<hiptest-uid>)
    ...
    Examples:
      ...
      | PARCEL EXCEPTION | INACCURATE ADDRESS | RTS          | PENDING SHIPPER | Number of parcels with exception cases | Parcels with Exception Cases | uid:ce66cbc2-3249-47ec-93bb-4749ae9286a4 |
  ...
  Scenario Outline: View Recovery Ticket  of Exception Cases Parcels (uid:ff67196f-4020-4a36-abf8-5e33420ca106)
    ...
    Examples:
      | TicketType    | TicketSubType    | OrderOutcome | TileName                               | ModalName                    |
      | SHIPPER ISSUE | DUPLICATE PARCEL | XMAS CAGE    | Number of parcels with exception cases | Parcels with Exception Cases |
