...
Feature: Priority Parcel in Hub
  ...
  Scenario Outline: View Priority Parcel of Pending Ticket Status - Recovery Ticket Type = Shipper Issue (uid:8fa5f052-59e4-4154-819b-718d4d891984)
    ...
    Examples:
      ...
      | {hub-name-8} | {hub-id-8} | SHIPPER ISSUE | DUPLICATE PARCEL | CREATED | Priority parcels in hub | Priority Parcels in Hub | Please Confirm ETA of FSR Parcels to Proceed |
  ...
  Scenario Outline: View Priority Parcel of Pending Ticket Status - Recovery Ticket Type = Damaged (uid:3e196191-c4af-4184-a297-c05f0e05ac9b)
    ...
    Examples:
      ...
      | {hub-name-8} | {hub-id-8} | DAMAGED    | IMPROPER PACKAGING | NV LIABLE - FULL | CREATED | Priority parcels in hub | Priority Parcels in Hub | Please Confirm ETA of FSR Parcels to Proceed |
  ...
  Scenario Outline: View Priority Parcel of Pending Ticket Status - Recovery Ticket Type = Parcel Exception (uid:5b5e3a65-dfe2-4f30-b500-6ee5e8612f0a)
    ...
    Examples:
      | HubName      | HubId      | TicketType       | TicketSubType      | OrderOutcome | Status  | TileName                | ModalName               | FSRModalTitle                                |
      | {hub-name-8} | {hub-id-8} | PARCEL EXCEPTION | INACCURATE ADDRESS | RTS          | CREATED | Priority parcels in hub | Priority Parcels in Hub | Please Confirm ETA of FSR Parcels to Proceed |
  ...
  Scenario Outline: View Priority Parcel of Pending Ticket Status - Recovery Ticket Type = Parcel On Hold  (uid:df672d8b-ecc1-4fbc-99e9-34df243e8cc5)
    ...
    Examples:
      | HubName      | HubId      | TicketType     | TicketSubType   | OrderOutcome    | Status  | TileName                | ModalName               | FSRModalTitle                                |
      | {hub-name-8} | {hub-id-8} | PARCEL ON HOLD | SHIPPER REQUEST | RESUME DELIVERY | CREATED | Priority parcels in hub | Priority Parcels in Hub | Please Confirm ETA of FSR Parcels to Proceed |
  ...
  Scenario Outline: View Priority Parcel of In Progress Ticket Status - Recovery Ticket Type = Shipper Issue (uid:9300f0ce-bdd6-4698-a794-3bddc5ee4a38)
    ...
    Examples:
      | HubName      | HubId      | TicketType    | TicketSubType    | OrderOutcome | Status      | TileName                | ModalName               | FSRModalTitle                                |
      | {hub-name-8} | {hub-id-8} | SHIPPER ISSUE | DUPLICATE PARCEL | XMAS CAGE    | IN PROGRESS | Priority parcels in hub | Priority Parcels in Hub | Please Confirm ETA of FSR Parcels to Proceed |
  ...
  Scenario Outline: View Priority Parcel of In Progress Ticket Status - Recovery Ticket Type = Damaged (uid:0baddff7-c27b-4d03-890b-6b5399e906b0)
    ...
    Examples:
      | HubName      | HubId      | TicketType | TicketSubType      | OrderOutcome     | Status      | TileName                | ModalName               | FSRModalTitle                                |
      | {hub-name-8} | {hub-id-8} | DAMAGED    | IMPROPER PACKAGING | NV LIABLE - FULL | IN PROGRESS | Priority parcels in hub | Priority Parcels in Hub | Please Confirm ETA of FSR Parcels to Proceed |
  ...
  Scenario Outline: View Priority Parcel of In Progress Ticket Status - Recovery Ticket Type = Parcel Exception (uid:fb8b1046-7853-4152-802b-955f518d9abf)
    ...
    Examples:
      | HubName      | HubId      | TicketType       | TicketSubType      | OrderOutcome | Status      | TileName                | ModalName               | FSRModalTitle                                |
      | {hub-name-8} | {hub-id-8} | PARCEL EXCEPTION | INACCURATE ADDRESS | RTS          | IN PROGRESS | Priority parcels in hub | Priority Parcels in Hub | Please Confirm ETA of FSR Parcels to Proceed |
  ...
  Scenario Outline: View Priority Parcel of In Progress Ticket Status - Recovery Ticket Type = Parcel On Hold  (uid:f6916ba9-88ea-47e2-b5d3-ca7c409b4408)
    ...
    Examples:
      | HubName      | HubId      | TicketType     | TicketSubType   | OrderOutcome    | Status      | TileName                | ModalName               | FSRModalTitle                                |
      | {hub-name-8} | {hub-id-8} | PARCEL ON HOLD | SHIPPER REQUEST | RESUME DELIVERY | IN PROGRESS | Priority parcels in hub | Priority Parcels in Hub | Please Confirm ETA of FSR Parcels to Proceed |
  ...
  Scenario Outline: View Priority Parcel of On Hold Ticket Status - Recovery Ticket Type = Shipper Issue (uid:7e86bf11-0b25-42e1-baae-a875220d9fa5)
    ...
    Examples:
      | HubName      | HubId      | TicketType    | TicketSubType    | OrderOutcome | Status  | TileName                | ModalName               | FSRModalTitle                                |
      | {hub-name-8} | {hub-id-8} | SHIPPER ISSUE | DUPLICATE PARCEL | XMAS CAGE    | ON HOLD | Priority parcels in hub | Priority Parcels in Hub | Please Confirm ETA of FSR Parcels to Proceed |
  ...
  Scenario Outline: View Priority Parcel of On Hold Ticket Status - Recovery Ticket Type = Damaged (uid:dafb54ad-4ce5-45cb-b710-a54a321d3650)
    ...
    Examples:
      | HubName      | HubId      | TicketType | TicketSubType      | OrderOutcome     | Status  | TileName                | ModalName               | FSRModalTitle                                |
      | {hub-name-8} | {hub-id-8} | DAMAGED    | IMPROPER PACKAGING | NV LIABLE - FULL | ON HOLD | Priority parcels in hub | Priority Parcels in Hub | Please Confirm ETA of FSR Parcels to Proceed |
  ...
  Scenario Outline: View Priority Parcel of On Hold Ticket Status - Recovery Ticket Type = Parcel Exception (uid:a9d9e242-63a6-47eb-b192-3ae51d688e12)
    ...
    Examples:
      | HubName      | HubId      | TicketType       | TicketSubType      | OrderOutcome | Status  | TileName                | ModalName               | FSRModalTitle                                |
      | {hub-name-8} | {hub-id-8} | PARCEL EXCEPTION | INACCURATE ADDRESS | RTS          | ON HOLD | Priority parcels in hub | Priority Parcels in Hub | Please Confirm ETA of FSR Parcels to Proceed |
  ...
  Scenario Outline: View Priority Parcel of Pending Shipper Ticket Status - Recovery Ticket Type = Shipper Issue (uid:5cbabffd-dd14-4604-905b-191cfb44e93f)
    ...
    Examples:
      | HubName      | HubId      | TicketType    | TicketSubType    | OrderOutcome | Status          | TileName                | ModalName               | FSRModalTitle                                |
      | {hub-name-8} | {hub-id-8} | SHIPPER ISSUE | DUPLICATE PARCEL | XMAS CAGE    | PENDING SHIPPER | Priority parcels in hub | Priority Parcels in Hub | Please Confirm ETA of FSR Parcels to Proceed |
  ...
  Scenario Outline: View Priority Parcel of Pending Shipper Ticket Status - Recovery Ticket Type = Damaged (uid:fb550ebc-d73f-4ad4-bc46-0983a23cc5c8)
    ...
    Examples:
      | HubName      | HubId      | TicketType | TicketSubType      | OrderOutcome     | Status          | TileName                | ModalName               | FSRModalTitle                                |
      | {hub-name-8} | {hub-id-8} | DAMAGED    | IMPROPER PACKAGING | NV LIABLE - FULL | PENDING SHIPPER | Priority parcels in hub | Priority Parcels in Hub | Please Confirm ETA of FSR Parcels to Proceed |
  ...
  Scenario Outline: View Priority Parcel of Pending Shipper Ticket Status - Recovery Ticket Type = Parcel Exception (uid:bdfbf21c-2c6f-4c4a-9e42-587ceb475233)
    ...
    Examples:
      | HubName      | HubId      | TicketType       | TicketSubType      | OrderOutcome | Status          | TileName                | ModalName               | FSRModalTitle                                |
      | {hub-name-8} | {hub-id-8} | PARCEL EXCEPTION | INACCURATE ADDRESS | RTS          | PENDING SHIPPER | Priority parcels in hub | Priority Parcels in Hub | Please Confirm ETA of FSR Parcels to Proceed |
  ...
  Scenario Outline: View Priority Parcel of Pending Shipper Ticket Status - Recovery Ticket Type = Parcel On Hold (uid:4b6d1c14-bef8-4df5-b6e6-620e83b776fe)
    ...
    Examples:
      | HubName      | HubId      | TicketType     | TicketSubType   | OrderOutcome    | Status          | TileName                | ModalName               | FSRModalTitle                                |
      | {hub-name-8} | {hub-id-8} | PARCEL ON HOLD | SHIPPER REQUEST | RESUME DELIVERY | PENDING SHIPPER | Priority parcels in hub | Priority Parcels in Hub | Please Confirm ETA of FSR Parcels to Proceed |
