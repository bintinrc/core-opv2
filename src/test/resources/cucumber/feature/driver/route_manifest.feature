...
Feature: Route Manifest
  ...
  Scenario: View Un-verified POA/POH
    ...
    And API Driver - Driver submit POH and upload photo using data below:
      | submitPohRequest | {"arrival_lat":-6.2421224,"arrival_lng":106.8469057,"arrival_time":"2022-12-06T09:54:29+0700","final_parcel_count":2,"handover_time":"2022-12-06T09:55:09+0700","hub_staff_username":"ty","num_photos":1,"original_parcel_count":0,"route_external_ids":[{KEY_LIST_OF_CREATED_ROUTES[1].id}],"verification_type":"QR"} |
      | hubHandoverId    | 1                                                                                                                                                                                                                                                                                                                      |
    ...
    And Operator verifies Proof of Arrival table for the row number "1" on Route Manifest page:
      | arrivalDateTime     | 2022-12-06 10:54:29 |
      | verifiedByGps       | No                  |
