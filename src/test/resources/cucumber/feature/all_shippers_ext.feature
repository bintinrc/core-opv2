...
Feature: All Shippers
  ...
  Scenario Outline: Operator Create Marketplace Shipper (<hiptest-uid>)
    ...
    When Operator create new Shipper with basic settings using data below:
      ...
      | premiumPickupDailyLimit      | <premiumPickupDailyLimit>      |
    ...
    Examples:
      | Note       | hiptest-uid                              | isShipperActive | shipperType | ocVersion | services | trackingType | isAllowCod | isAllowCashPickup | isPrepaid | isAllowStagedOrders | isMultiParcelShipper | isDisableDriverAppReschedule | premiumPickupDailyLimit |
      | Shipper V4 | uid:bc736a20-01fe-40d6-8839-dc7dcdf4c5d7 | true            | Marketplace | v4        | NEXTDAY  | Fixed        | false      | true              | true      | false               | false                | false                        | 3                       |
