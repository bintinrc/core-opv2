...
Feature: DP Vault Management
  ...
  @LaunchBrowser @DpVaultManagement#01 @DpVaultManagement#02 @DpVaultManagement#03
  Scenario: Login to Operator V2
    Given op login into Operator V2 with username "{operator-portal-uid}" and password "{operator-portal-pwd}"

  @DpVaultManagement#01
  ...
  @KillBrowser @DpVaultManagement#01 @DpVaultManagement#02 @DpVaultManagement#03
