@OperatorV2 @Core @RoutingID @DriverRouteCODLimit @DriverCodLimitIDPart6 @wip2
...
#      verify 2nd not order routed
  ...
  Scenario: Operator Allow to Add Multiple Orders with COD <30 Millions to Multiple Driver Routes on Zonal Routing
    ...
    Given API Order - Shipper create multiple V4 orders using data below:
      ...
      | numberOfOrder       | 1                                                                                                                                                                                                                                                                                                                                                             |
      | generateFromAndTo   | RANDOM                                                                                                                                                                                                                                                                                                                                                        |
      | v4OrderRequest      | { "service_type":"Parcel", "service_level":"Standard", "parcel_job":{ "cash_on_delivery":29000000, "is_pickup_required":false, "pickup_date":"{{next-1-day-yyyy-MM-dd}}", "pickup_timeslot":{ "start_time":"12:00", "end_time":"15:00"}, "delivery_start_date":"{{next-1-day-yyyy-MM-dd}}", "delivery_timeslot":{ "start_time":"09:00", "end_time":"22:00"}}} |
    Given API Order - Shipper create multiple V4 orders using data below:
      | shipperClientId     | {shipper-v4-client-id}                                                                                                                                                                                                                                                                                                                                       |
      | shipperClientSecret | {shipper-v4-client-secret}                                                                                                                                                                                                                                                                                                                                   |
      | numberOfOrder       | 1                                                                                                                                                                                                                                                                                                                                                            |
