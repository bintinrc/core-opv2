...
Feature: Create Route Groups
  ...
  Scenario: Operator Add Transaction to Route Group on Create Route Groups (uid:f78a6a4f-cac1-40a4-a405-5fcf375abce7)
    ...
    And Operator removes all General Filters except following on Create Route Groups page: "Creation Time"
  ...
  Scenario: Operator Add Reservation to Route Group on Create Route Groups (uid:ac76c33c-0e18-4a3f-957c-211444d4d708)
    ...
    When Operator go to menu Routing -> 1. Create Route Groups
    And Operator wait until 'Create Route Groups' page is loaded
    And Operator removes all General Filters except following on Create Route Groups page: "Creation Time, Shipper"
    And Operator add following filters on General Filters section on Create Route Groups page:
      | Creation Time | Today                 |
  ...
  Scenario: Operator Filter Routed Transaction on Create Route Groups (uid:8b96252f-32bc-49e4-9768-ad802929f298)
    ...
    When Operator go to menu Routing -> 1. Create Route Groups
    And Operator wait until 'Create Route Groups' page is loaded
    And Operator removes all General Filters except following on Create Route Groups page: "Creation Time, Routed"
    And Operator add following filters on General Filters section on Create Route Groups page:
      | Creation Time | Today |
      | Routed        | Show  |
    And Operator choose "Include Transactions" on Transaction Filters section on Create Route Groups page
  ...
  Scenario: Operator Filter DP Order on Create Route Groups (uid:10fe0704-11ba-41b5-8ca2-00e695092078)
    ...
    When Operator go to menu Routing -> 1. Create Route Groups
    And Operator wait until 'Create Route Groups' page is loaded
    And Operator removes all General Filters except following on Create Route Groups page: "Creation Time, Shipper, DP Order"
    And Operator add following filters on General Filters section on Create Route Groups page:
      | Creation Time | Today                 |
      | Shipper       | {filter-shipper-name} |
      | DP Order      | {dp-name}             |
  ...
  Scenario: Operator Filter Route Grouping on Create Route Groups (uid:3abb3461-9ffa-486d-b5e5-4949c87644fc)
    ...
    And Operator wait until 'Create Route Groups' page is loaded
    And Operator removes all General Filters except following on Create Route Groups page: "Route Grouping"
    And Operator add following filters on General Filters section on Create Route Groups page:
  ...
  Scenario: Operator Filter Route Grouping on Create Route Groups (uid:3abb3461-9ffa-486d-b5e5-4949c87644fc)
    ...
    When Operator go to menu Routing -> 1. Create Route Groups
    And Operator wait until 'Create Route Groups' page is loaded
    And Operator removes all General Filters except following on Create Route Groups page: "Creation Time, Route Grouping"
    And Operator add following filters on General Filters section on Create Route Groups page:
      | Creation Time  | Today                          |
      | Route Grouping | {KEY_CREATED_ROUTE_GROUP.name} |
    And Operator choose "Include Transactions" on Transaction Filters section on Create Route Groups page
