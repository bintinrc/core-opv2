...
Feature: Route Logs - Merge Transactions - TH - Can Merge
  ...
  Scenario Outline: Route Logs - Operator Merge Multiple Transactions of Single Route - Pickup Transactions - All Same - Can Merge
...
#    orphaned waypoint is unrouted
  ...
  @ArchiveRouteCommonV2 @MediumPriority
  Scenario Outline: Route Logs - Operator Merge Multiple Transactions of Single Route - Delivery Transactions - All Same - Can Merge
    Given API Order - Shipper create multiple V4 orders using data below:
      | shipperClientId     | {shipper-v4-client-id}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
      | shipperClientSecret | {shipper-v4-client-secret}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
#    orphaned waypoint is unrouted
  ...
  @ArchiveRouteCommonV2 @MediumPriority
  Scenario Outline: Route Logs - Operator Merge Multiple Transactions of Single Route - Pickup Transactions - Different Email - Can Merge
    Given API Order - Shipper create multiple V4 orders using data below:
      | shipperClientId     | {shipper-v4-client-id}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
      | shipperClientSecret | {shipper-v4-client-secret}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
      | v4OrderRequest      | { "service_type":"<service_type>","service_level":"Standard","<direction>":{"name": "binti v4.1","phone_number": "<phone_number_1>","email": "<email_1>", "address": {"address1": "Orchard Road central","address2": "","country": "TH","postcode": "10100","latitude": 1.3248209,"longitude": 103.6983167}},"to": { "name": "binti v4.1", "phone_number": "+6595557073", "email": "aaa@mail.com", "address": { "address1": "Orchard Road central", "address2": "", "country": "TH", "postcode": "10100", "latitude": 1.3248209, "longitude": 103.6983167 } },"parcel_job":{ "is_pickup_required":<is_pickup_required>, "pickup_date":"{date: 1 days next, yyyy-MM-dd}", "pickup_timeslot":{ "start_time":"09:00", "end_time":"22:00"}, "delivery_start_date":"{date: 1 days next, yyyy-MM-dd}", "delivery_timeslot":{ "start_time":"09:00", "end_time":"22:00"}}} |
...
#    orphaned waypoint is unrouted
  ...
  @ArchiveRouteCommonV2 @MediumPriority
  Scenario Outline: Route Logs - Operator Merge Multiple Transactions of Single Route - Delivery Transactions - Different Email - Can Merge
    Given API Order - Shipper create multiple V4 orders using data below:
      | shipperClientId     | {shipper-v4-client-id}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
      | shipperClientSecret | {shipper-v4-client-secret}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
      | <generateAddress>   | RANDOM                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
#    orphaned waypoint is unrouted
  ...
  @ArchiveRouteCommonV2 @MediumPriority
  Scenario Outline: Route Logs - Operator Merge Multiple Transactions of Single Route - Pickup Transactions - Invalid Phone Number - Can Merge
    Given API Order - Shipper create multiple V4 orders using data below:
      | shipperClientId     | {shipper-v4-client-id}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
      | shipperClientSecret | {shipper-v4-client-secret}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
      | v4OrderRequest      | { "service_type":"<service_type>","service_level":"Standard","<direction>":{"name": "binti v4.1","phone_number": "<phone_number_1>","email": "<email_1>", "address": {"address1": "Orchard Road central","address2": "","country": "TH","postcode": "10100","latitude": 1.3248209,"longitude": 103.6983167}},"to": { "name": "binti v4.1", "phone_number": "+6595557073", "email": "aaa@mail.com", "address": { "address1": "Orchard Road central", "address2": "", "country": "TH", "postcode": "10100", "latitude": 1.3248209, "longitude": 103.6983167 } },"parcel_job":{ "is_pickup_required":<is_pickup_required>, "pickup_date":"{date: 1 days next, yyyy-MM-dd}", "pickup_timeslot":{ "start_time":"09:00", "end_time":"22:00"}, "delivery_start_date":"{date: 1 days next, yyyy-MM-dd}", "delivery_timeslot":{ "start_time":"09:00", "end_time":"22:00"}}} |
...
#    orphaned waypoint is unrouted
  ...
  @ArchiveRouteCommonV2 @MediumPriority
  Scenario Outline: Route Logs - Operator Merge Multiple Transactions of Single Route - Delivery Transactions - Invalid Phone Number - Can Merge
    Given API Order - Shipper create multiple V4 orders using data below:
      | shipperClientId     | {shipper-v4-client-id}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
      | shipperClientSecret | {shipper-v4-client-secret}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
      | <generateAddress>   | RANDOM                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
#    orphaned waypoint is unrouted
  ...
  @ArchiveRouteCommonV2 @MediumPriority
  Scenario Outline: Route Logs - Operator Merge Multiple Transactions of Single Route - Pickup Transactions - Invalid Email - Can Merge
    Given API Order - Shipper create multiple V4 orders using data below:
      | shipperClientId     | {shipper-v4-client-id}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
      | shipperClientSecret | {shipper-v4-client-secret}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
      | v4OrderRequest      | { "service_type":"<service_type>","service_level":"Standard","<direction>":{"name": "binti v4.1","phone_number": "<phone_number_1>","email": "<email_1>", "address": {"address1": "Orchard Road central","address2": "","country": "TH","postcode": "10100","latitude": 1.3248209,"longitude": 103.6983167}},"to": { "name": "binti v4.1", "phone_number": "+6595557073", "email": "aaa@mail.com", "address": { "address1": "Orchard Road central", "address2": "", "country": "TH", "postcode": "10100", "latitude": 1.3248209, "longitude": 103.6983167 } },"parcel_job":{ "is_pickup_required":<is_pickup_required>, "pickup_date":"{date: 1 days next, yyyy-MM-dd}", "pickup_timeslot":{ "start_time":"09:00", "end_time":"22:00"}, "delivery_start_date":"{date: 1 days next, yyyy-MM-dd}", "delivery_timeslot":{ "start_time":"09:00", "end_time":"22:00"}}} |
...
#    orphaned waypoint is unrouted
  ...
  @ArchiveRouteCommonV2 @MediumPriority
  Scenario Outline: Route Logs - Operator Merge Multiple Transactions of Single Route - Delivery Transactions - Invalid Email - Can Merge
    Given API Order - Shipper create multiple V4 orders using data below:
      | shipperClientId     | {shipper-v4-client-id}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
      | shipperClientSecret | {shipper-v4-client-secret}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
      | <generateAddress>   | RANDOM                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
#    orphaned waypoint is unrouted
  ...
  @ArchiveRouteCommonV2 @MediumPriority
  Scenario Outline: Route Logs - Operator Merge Multiple Transactions of Single Route - Pickup Transactions - Different Order Status - Can Merge
    Given API Order - Shipper create multiple V4 orders using data below:
      | shipperClientId     | {shipper-v4-client-id}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
      | shipperClientSecret | {shipper-v4-client-secret}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
      | v4OrderRequest      | { "service_type":"<service_type>","service_level":"Standard","<direction>":{"name": "binti v4.1","phone_number": "<phone_number_1>","email": "<email_1>", "address": {"address1": "Orchard Road central","address2": "","country": "TH","postcode": "10100","latitude": 1.3248209,"longitude": 103.6983167}},"to": { "name": "binti v4.1", "phone_number": "+6595557073", "email": "aaa@mail.com", "address": { "address1": "Orchard Road central", "address2": "", "country": "TH", "postcode": "10100", "latitude": 1.3248209, "longitude": 103.6983167 } },"parcel_job":{ "is_pickup_required":<is_pickup_required>, "pickup_date":"{date: 1 days next, yyyy-MM-dd}", "pickup_timeslot":{ "start_time":"09:00", "end_time":"22:00"}, "delivery_start_date":"{date: 1 days next, yyyy-MM-dd}", "delivery_timeslot":{ "start_time":"09:00", "end_time":"22:00"}}} |
...
#    orphaned waypoint is unrouted
  ...
  @ArchiveRouteCommonV2 @MediumPriority
  Scenario Outline: Route Logs - Operator Merge Multiple Transactions of Single Route - Delivery Transactions - Different Order Status - Can Merge
    Given API Order - Shipper create multiple V4 orders using data below:
      | shipperClientId     | {shipper-v4-client-id}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
      | shipperClientSecret | {shipper-v4-client-secret}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
      | <generateAddress>   | RANDOM                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
