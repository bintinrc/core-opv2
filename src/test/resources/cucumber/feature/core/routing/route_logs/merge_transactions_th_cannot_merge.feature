...
Feature: Route Logs - Merge Transactions - TH - Cannot Merge
  ...
  @ArchiveRouteCommonV2 @happy-path @HighPriority
  Scenario: Operator Merge Transactions of Multiple Routes from Route Logs Page - Delivery Transactions - Tagged with Same DP - Cannot Merge
    Given API Core - Operator create new route using data below:
      | createRouteRequest | { "zoneId":{zone-id}, "hubId":{hub-id}, "driverId":{ninja-driver-id} } |
    And API Core - Operator create new route using data below:
      | createRouteRequest | { "zoneId":{zone-id}, "hubId":{hub-id}, "driverId":{ninja-driver-id} } |
  ...
  @ArchiveRouteCommonV2 @MediumPriority
  Scenario Outline: Operator Merge Multiple Transactions of Single Route - Pickup Transaction - Different Address, Approximate Coordinate - Cannot Merge
    Given API Order - Shipper create multiple V4 orders using data below:
      | shipperClientId     | {shipper-v4-client-id}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
      | shipperClientSecret | {shipper-v4-client-secret}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
  ...
  @ArchiveRouteCommonV2 @MediumPriority
  Scenario Outline: Operator Merge Multiple Transactions of Single Route - Delivery Transaction - Different Address, Approximate Coordinate - Cannot Merge
    Given API Order - Shipper create multiple V4 orders using data below:
      | shipperClientId     | {shipper-v4-client-id}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
      | shipperClientSecret | {shipper-v4-client-secret}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
      | <generateAddress>   | RANDOM                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
  ...
  @ArchiveRouteCommonV2 @MediumPriority
  Scenario Outline: Operator Merge Multiple Transactions of Single Route - Pickup Transaction - Different Delivery Verification Mode - Cannot Merge
    Given API Order - Shipper create multiple V4 orders using data below:
      | shipperClientId     | {shipper-v4-client-id}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
      | shipperClientSecret | {shipper-v4-client-secret}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
  ...
  @ArchiveRouteCommonV2 @MediumPriority
  Scenario Outline: Operator Merge Multiple Transactions of Single Route - Delivery Transaction - Different Delivery Verification Mode - Cannot Merge
    Given API Order - Shipper create multiple V4 orders using data below:
      | shipperClientId     | {shipper-v4-client-id}                                                                                                                                                                                                                                                                                                                                                                                                                                              |
      | shipperClientSecret | {shipper-v4-client-secret}                                                                                                                                                                                                                                                                                                                                                                                                                                          |
