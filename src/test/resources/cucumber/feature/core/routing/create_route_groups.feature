...
Feature: Create Route Groups
  ...
  Scenario Outline: Operator Filter Order by Service Type on Create Route Group Page - <service_type> (<hiptest-uid>)
    ...
    Examples:
      | service_type  | status         | type                 | v4OrderRequest                                                                                                                                                                                                                                                        | hiptest-uid                              |
      | International | Pending Pickup | DELIVERY Transaction | { "service_type":"International", "service_level":"Standard", "parcel_job":{ "is_pickup_required":false, "delivery_start_date":"{{next-1-day-yyyy-MM-dd}}", "delivery_timeslot":{ "start_time":"09:00", "end_time":"22:00"}}, "international":{"portation":"import"}} | uid:817e61ac-581e-41be-9618-61ec9d3a882f |
