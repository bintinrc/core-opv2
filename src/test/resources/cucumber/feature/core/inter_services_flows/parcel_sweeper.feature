@OperatorV2 @Core @InterServicesFlows @ParcelSweeperLive @wipFeature
Feature: Parcel Sweeper Live
  ...
  @DeleteOrArchiveRoute @ForceSuccessOrder @wipScenario
  Scenario: Operator Parcel Sweep Scans a Routed Parcel
    ...
    And DB Core - verify orders record:
      | latestWarehouseSweepId | {KEY_CORE_WAREHOUSE_SWEEPS[1]} |
