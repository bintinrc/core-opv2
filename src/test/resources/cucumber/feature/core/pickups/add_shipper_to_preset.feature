...
Feature: Add Shipper To Preset
  ...
  Scenario: Operator Add New Shipper to Existing Shipper Pickup Preset Filters on Add Shipper to Preset Page - Single Address
  ...
  @DeleteShipperPickupFilterTemplate
  Scenario: Operator Add New Shipper to Existing Shipper Pickup Preset Filters on Add Shipper to Preset Page - Multiple Addresses
    Given API Operator creates new Shipper Pickup Filter Template using data below:
      | name                | TA_TEMPLATE_{gradle-current-date-yyyyMMddHHmmsss} |
      | reservationTimeFrom | {gradle-current-date-yyyy-MM-dd}                  |
      | reservationTimeTo   | {gradle-current-date-yyyy-MM-dd}                  |
