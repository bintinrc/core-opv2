...
Feature: Mask Order Info
  ...
  Scenario: Operator View Edit Order Details - Order Events Masked
    ...
    Then Operator verify order event on Edit Order V2 page using data below:
      | name        | UPDATE AV                                                                                                                                                                                                                                                                                                          |
      | description | User: AUTO (system AV) (support@ninjavan.co) Address: Click to reveal (tracked)D MANDAI SQUARE 116 Kilang Timur\|\|\|\|308412 Address Type: ADDRESS_TYPE_DELIVERY Zone ID: 34654 Destination Hub ID: 1 Lat, Long: 1.288148, 103.740232 Address Status: VERIFIED AV Mode (Manual/Auto): MANUAL Source: FROM_SHIPPER |
