...
Feature: Waypoint Performance
  ...
  Scenario: View Waypoint Performance of Success Waypoints on Route Inbound Page
    ...
    And API Driver - Driver read routes:
      ...
      | expectedWaypointIds | {KEY_LIST_OF_CREATED_ORDERS[1].transactions[1].waypointId},{KEY_LIST_OF_CREATED_RESERVATIONS[1].waypointId},{KEY_LIST_OF_CREATED_ORDERS[3].transactions[2].waypointId} |
  ...
  Scenario: View Waypoint Performance of Failed Waypoints on Route Inbound Page
    ...
    And API Driver - Driver read routes:
      | driverId            | {ninja-driver-id}                                                                                                                                                      |
      | expectedRouteId     | {KEY_LIST_OF_CREATED_ROUTES[1].id}                                                                                                                                     |
      | expectedWaypointIds | {KEY_LIST_OF_CREATED_RESERVATIONS[1].waypointId},{KEY_LIST_OF_CREATED_ORDERS[1].transactions[1].waypointId},{KEY_LIST_OF_CREATED_ORDERS[2].transactions[2].waypointId} |
    And API Driver - Driver submit POD:
      | routeId         | {KEY_LIST_OF_CREATED_ROUTES[1].id}               |
      | waypointId      | {KEY_LIST_OF_CREATED_RESERVATIONS[1].waypointId} |
      | routes          | KEY_DRIVER_ROUTES                                |
