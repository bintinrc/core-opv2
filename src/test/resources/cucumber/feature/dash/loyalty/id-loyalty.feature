@MileZero @IdOnly @LoyaltyId @Deprecated @ToBeUpdated
Feature: Loyalty

  @DeleteOrArchiveRoute
  Scenario: Loyalty - normal shipper - point accumulation - id (uid:00b72a8f-80bd-4586-a0cb-3439e7b632ac)
  ...
  @DeleteOrArchiveRoute
  Scenario: Loyalty - marketplace shipper - point accumulation - id (uid:98bb4fd6-4464-47e1-b4a3-1318109ec1fd)
