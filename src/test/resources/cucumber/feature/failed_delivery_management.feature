...
Feature: Failed Delivery Management
  ...
  @ArchiveRoute
  Scenario Outline: Operator find failed delivery order on Failed Delivery orders list
    ...
    Examples:
      ...
      | Normal | uid:8e27fdff-334b-4fc3-b0b6-a2826ba284c0 | Normal    | S-N-{{tracking_ref_no}} Shipper  | shipper.normal.{{tracking_ref_no}}@test.com  | C-N-{{tracking_ref_no}} Customer | customer.normal.{{tracking_ref_no}}@test.com |
