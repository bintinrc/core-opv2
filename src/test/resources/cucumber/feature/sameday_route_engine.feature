...
Feature: Sameday Route Engine
  ...
  Scenario: Add sameday parcel to route (uid:24baa07a-b688-4586-8a90-e5154031b1f1)
    ...
    Given Shipper create Order V2 Parcel using data below:
      | v2OrderRequest | {"from_postcode":"159363","from_address1":"30 Jalan Kilang Barat","from_address2":"Ninja Van HQ","from_city":"SG","from_state":"SG","from_country":"SG","to_postcode":"318993","to_address1":"998 Toa Payoh North","to_address2":"#01-10","to_city":"SG","to_state":"SG","to_country":"SG","delivery_date":"{{cur_date}}","pickup_date":"{{cur_date}}","pickup_reach_by":"{{cur_date}} 15:00:00","delivery_reach_by":"{{cur_date}} 17:00:00","weekend":true,"staging":false,"pickup_timewindow_id":1,"delivery_timewindow_id":2,"max_delivery_days":0,"instruction":"This order is created for testing purpose only. Ignore this order. Created at {{created_date}} by feature @SamedayRouteEngine.","tracking_ref_no":"{{tracking_ref_no}}","shipper_order_ref_no":"{{tracking_ref_no}}","type":"Normal","parcels":[{"parcel_size_id":0,"volume":1,"weight":4}]} |
  ...
  Scenario: Add bulky parcel to route (uid:477e2e7a-76e7-40e7-8355-866783b2faaa)
    ...
    Given Shipper create Order V2 Parcel using data below:
      | v2OrderRequest | {"from_postcode":"159363","from_address1":"30 Jalan Kilang Barat","from_address2":"Ninja Van HQ","from_city":"SG","from_state":"SG","from_country":"SG","to_postcode":"318993","to_address1":"998 Toa Payoh North","to_address2":"#01-10","to_city":"SG","to_state":"SG","to_country":"SG","delivery_date":"{{cur_date}}","pickup_date":"{{cur_date}}","pickup_reach_by":"{{cur_date}} 15:00:00","delivery_reach_by":"{{cur_date}} 17:00:00","weekend":true,"staging":false,"pickup_timewindow_id":1,"delivery_timewindow_id":2,"max_delivery_days":0,"instruction":"This order is created for testing purpose only. Ignore this order. Created at {{created_date}} by feature @SamedayRouteEngine.","tracking_ref_no":"{{tracking_ref_no}}","shipper_order_ref_no":"{{tracking_ref_no}}","type":"C2C","parcels":[{"parcel_size_id":0,"volume":1,"weight":4,"bulky_job":{"installation_required":true,"flight_of_stairs":1,"sku":"AUTOMATA1"}}]} |
    Given Operator go to menu Routing -> 2. Route Group Management
    Then op wait until 'Route Group' page is loaded
    When op create new 'route group' on 'Route Groups' using data below:
      | generateName | false |
  ...
  Scenario: Download same day route engine csv export (uid:5247e84e-d36d-4ddd-96db-63b5fddfee77)
    ...
    Given Shipper create Order V2 Parcel using data below:
      | v2OrderRequest | {"from_postcode":"159363","from_address1":"30 Jalan Kilang Barat","from_address2":"Ninja Van HQ","from_city":"SG","from_state":"SG","from_country":"SG","to_postcode":"318993","to_address1":"998 Toa Payoh North","to_address2":"#01-10","to_city":"SG","to_state":"SG","to_country":"SG","delivery_date":"{{cur_date}}","pickup_date":"{{cur_date}}","pickup_reach_by":"{{cur_date}} 23:15:00","delivery_reach_by":"{{cur_date}} 23:30:00","weekend":true,"staging":false,"pickup_timewindow_id":1,"delivery_timewindow_id":2,"max_delivery_days":0,"instruction":"This order is created for testing purpose only. Ignore this order. Created at {{created_date}} by feature @SamedayRouteEngine.","tracking_ref_no":"{{tracking_ref_no}}","shipper_order_ref_no":"{{tracking_ref_no}}","type":"C2C","parcels":[{"parcel_size_id":0,"volume":1,"weight":4,"bulky_job":{"installation_required":true,"flight_of_stairs":1,"sku":"AUTOMATA1"}}]} |
    Given Operator go to menu Routing -> 2. Route Group Management
    Then op wait until 'Route Group' page is loaded
    When op create new 'route group' on 'Route Groups' using data below:
      | generateName | false |
