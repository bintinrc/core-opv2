@OperatorV2 @OperatorV2Part2 @SamedayRouteEngine @CWF @SIT
Feature: Sameday Route Engine
  ...
  Scenario: Add sameday parcel to route (uid:24baa07a-b688-4586-8a90-e5154031b1f1)
    #Notes: Shipper create sameday parcel with OC V4
    ...
    Then Operator wait until 'Route Group Management' page is loaded
    ...
    Then Operator create the suggested route with driver name = "{ninja-driver-name}"
    Given Operator go to menu Routing -> 2. Route Group Management
