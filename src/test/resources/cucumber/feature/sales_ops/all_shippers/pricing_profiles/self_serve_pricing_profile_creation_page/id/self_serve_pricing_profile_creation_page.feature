@OperatorV2 @AllShippers @LaunchBrowser @EnableClearCache @SelfServePricingProfileID
Feature: Self-Serve Pricing Profile Creation Page -ID
  ...
  Scenario: Upload Pricing Profiles with CSV - Success Create Pricing Profiles with All Pricing Levers - ID (uid:356a98ef-0c37-4d28-834e-eaa03df4b035)
