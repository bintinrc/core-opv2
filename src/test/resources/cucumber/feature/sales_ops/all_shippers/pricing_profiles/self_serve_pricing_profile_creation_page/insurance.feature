...
Feature: INSURANCE
  ...
  Scenario: Upload Bulk Pricing Profiles CSV - Failed Create Pricing Profiles with Insurance Settings - Upload pricing profile error (uid:c67ef533-9e92-4aff-a988-d9aa2ee2222b)
    ...
    And Operator uploads csv file with below data:
      ...
      | {KEY_LEGACY_SHIPPER_ID} | {KEY_SHIPPER_ID} | {pricing-script-id-all} | {date: 1 days next, d/M/yyyy} | 10.00                | FLAT          | 100 | surcharge | 3              | 4           | {empty}              | 20                | 10                  | LEGACY               |
      | {KEY_LEGACY_SHIPPER_ID} | {KEY_SHIPPER_ID} | {pricing-script-id-all} | {date: 1 days next, d/M/yyyy} | 10.00                | FLAT          | 100 | surcharge | 3              | 4           | 1.5                  | 20                | {empty}             | LEGACY               |
      | {KEY_LEGACY_SHIPPER_ID} | {KEY_SHIPPER_ID} | {pricing-script-id-all} | {date: 1 days next, d/M/yyyy} | 10.00                | FLAT          | 100 | surcharge | 3              | 4           | 1.5                  | {empty}           | 10                  | LEGACY               |
      | {KEY_LEGACY_SHIPPER_ID} | {KEY_SHIPPER_ID} | {pricing-script-id-all} | {date: 1 days next, d/M/yyyy} | 10.00                | FLAT          | 100 | surcharge | 3              | 4           | 1.5                  | 20                | 100000000000.00     | LEGACY               |
  ...
  Scenario: Upload Bulk Pricing Profiles CSV - Failed Create Pricing Profiles with Insurance Settings - Pricing profile validation error (uid:a071e5e4-8e7c-453c-9699-2e63d8a723ad)
    ...
    And Operator uploads csv file with below data:
      | shipper_id              | global_id        | pricing_script_id       | effective_date                | salesperson_discount | discount_type | rts | rts_type  | cod_percentage | cod_min_fee | insurance_percentage | insurance_min_fee | insurance_threshold | billing_weight_logic |
      | {KEY_LEGACY_SHIPPER_ID} | {KEY_SHIPPER_ID} | {pricing-script-id-all} | {date: 1 days next, d/M/yyyy} | 10.00                | FLAT          | 100 | surcharge | 3              | 4           | 200                  | 20                | 10                  | LEGACY               |
