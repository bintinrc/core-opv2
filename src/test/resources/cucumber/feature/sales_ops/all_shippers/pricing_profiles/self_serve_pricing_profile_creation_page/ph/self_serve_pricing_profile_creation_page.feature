@OperatorV2 @AllShippers @LaunchBrowser @EnableClearCache @SelfServePricingProfilePH
Feature: Self-Serve Pricing Profile Creation Page - PH
  ...
  Scenario: Upload Pricing Profiles with CSV - Success Create Pricing Profiles with All Pricing Levers - PH (uid:601f2868-70c3-440e-8a49-b725ca7616da)
