@OperatorV2 @AllShippers @LaunchBrowser @EnableClearCache @SelfServePricingProfileVN
Feature: Self-Serve Pricing Profile Creation Page - NV
  ...
  Scenario: Upload Pricing Profiles with CSV - Success Create Pricing Profiles with All Pricing Levers - VN (uid:d8dbffc8-a4b0-47d3-8532-0b8765e7f84a)
