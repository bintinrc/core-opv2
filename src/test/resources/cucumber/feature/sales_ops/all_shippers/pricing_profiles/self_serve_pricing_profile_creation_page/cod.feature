...
Feature: COD
  ...
  Scenario: Upload Bulk Pricing Profiles CSV - Failed Create Pricing Profiles with COD Settings - Upload pricing profile error (uid:757f8f1f-b614-435b-b4c2-11a371ab53d9)
    ...
    And Operator uploads csv file with below data:
      ...
      | {KEY_LEGACY_SHIPPER_ID} | {KEY_SHIPPER_ID} | {pricing-script-id-all} | {date: 1 days next, d/M/yyyy} | 10.00                | FLAT          | 100 | surcharge | 3              | {empty}     | 1.5                  | 20                | 10                  | LEGACY               |
      | {KEY_LEGACY_SHIPPER_ID} | {KEY_SHIPPER_ID} | {pricing-script-id-all} | {date: 1 days next, d/M/yyyy} | 10.00                | FLAT          | 100 | surcharge | {empty}        | 4           | 1.5                  | 20                | 1.5                 | LEGACY               |
