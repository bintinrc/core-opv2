@OperatorV2 @AllShippers @LaunchBrowser @EnableClearCache @SelfServePricingProfileMY
Feature: Self-Serve Pricing Profile Creation Page - MY
  ...
  Scenario: Upload Pricing Profiles with CSV - Success Create Pricing Profiles with All Pricing Levers - MY (uid:3d84c510-7fb6-4d73-8c7f-67bc2badea6a)
