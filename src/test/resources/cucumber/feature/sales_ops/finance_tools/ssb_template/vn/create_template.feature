@OperatorV2 @ShipperSupport @OperatorV2Part1 @LaunchBrowser @SalesOpsVN @SSBVN @CreateTemplateVN
...
Feature: Create SSB Template
  ...
  @DeleteSsbTemplate
  Scenario: Create New Template - VN Characters (uid:54411130-db2c-45ba-92b7-1338833feb48)
