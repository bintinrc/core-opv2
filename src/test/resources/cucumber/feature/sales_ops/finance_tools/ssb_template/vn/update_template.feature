@OperatorV2 @ShipperSupport @OperatorV2Part1 @LaunchBrowser @SalesOpsVN @SSBVN @UpdateTemplateVN
...
Feature: Update Template
  ...
  @DeleteSsbTemplate
  Scenario: Update Template - Add Some Columns - VN (uid:83e41d56-6816-49f2-8a59-b925579e51e3)
