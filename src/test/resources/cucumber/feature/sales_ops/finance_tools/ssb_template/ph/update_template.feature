@OperatorV2 @ShipperSupport @OperatorV2Part1 @LaunchBrowser @SalesOpsPH @SSBPH @UpdateTemplatePH
...
Feature: Update Template
  ...
  @DeleteSsbTemplate
  Scenario: Update Template - Add Some Columns - PH (uid:7183fe73-bebb-4f87-901e-30a1bf59d0f7)
