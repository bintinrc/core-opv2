@OperatorV2 @ShipperSupport @OperatorV2Part1 @LaunchBrowser @SalesOpsTH @SSBTH @UpdateTemplateTH
...
Feature: Update Template
  ...
  @DeleteSsbTemplate
  Scenario: Update Template - Add Some Columns - TH (uid:8d1504d7-cdd7-4f58-9104-8111dd2c6236)
