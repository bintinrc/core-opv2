...
Feature: Generate Success Billing - Select By Script ID
  ...
  Background: Login to Operator Portal V2  and go to Order Billing Page
    ...
    Given API Gmail - Operator marks gmail messages as read
  ...
  Scenario: Generate "AGGREGATED" Success Billing Report - Select By Script ID (uid:7b57111a-cab7-4f9e-b0d6-45c53df142dc)
    ...
    And DB Billing - Operator gets the orders grouped by shipper and parcel size and weight from Billing database for scriptId "{pricing-script-id-all}"
