...
#    Given Operator login with username = "nadeera.deraniyagala@gmail.com" and password = "N@dz#1234"
    Given Operator login with username = "{operator-portal-uid}" and password = "{operator-portal-pwd}"
#    Given API Operator whitelist email "nadeera.deraniyagala@gmail.com"
  ...
  Scenario: Upload Invoice Orders CSV - Some Orders are non-invoiced, Some Orders are non-priced neither non-invoiced (uid:531d9dea-0866-48e5-9fb8-522d029e696d)
    Given API Shipper create multiple V4 orders using data below:
      | numberOfOrder       | 2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
      | shipperClientId     | {shipper-sop-normal-no-pricing-profile-2-client-id}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
      | shipperClientSecret | {shipper-sop-normal-no-pricing-profile-2-client-secret}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
    ...
    And Operator checks below for order id "{KEY_LIST_OF_CREATED_ORDER_ID[1]}"
    And API Operator force succeed created order
    And API Operator force succeed created order "{KEY_LIST_OF_CREATED_ORDER_ID[1]}"
