...
Feature: Pricing Scripts V2
  ...
  @DeletePricingScript
  Scenario Outline: Create Draft Script - <dataset_name> (<hiptest-uid>)
    Given Operator go to menu Shipper -> Pricing Scripts V2
    When Operator create new Draft Script using data below:
    ...
    Then Operator verify the new Script is created successfully on Drafts
    Examples:
      | deliveryType | orderType | origin   | fromDp | destination   | toDp  | size | weight | insurance | cod   | unitCostResult | packageValue | formulaCommentsResult | dataset_name                           | hiptest-uid                              |
      | Standard     | Normal    | Origin-1 | false  | Destination-1 | false | S    | 1      | false     | false | 8.0            | 10           | OK                    | Standard - Normal -  -  - S - 1 - TRUE | uid:c5547380-8b96-4454-9aeb-a482afea9115 |
  ...
  Scenario Outline: Create and Check Script with from_l1, from_l2, from_l3, to_l1, to_l2, to_l3 - <dataset_name>(<hiptest-uid>)
    ...
    Examples:
      ...
      | Inputs from L1 and to L1 | Holland Rd | University Rd |           |            |             |             | 2.14       | 0.14 | 2.0         | 0            | 0      | 0           | OK       | uid:74636785-935a-4027-9bc9-596722b3a06f | Inputs from L1 and to L1 |
      | Inputs From L2 and To L2 |            |               | Dover Ave | Jln Bahasa |             |             | 3.21       | 0.21 | 3.0         | 0            | 0      | 0           | OK       | uid:340d16f4-dae8-45e3-98d2-ccc74ea4f540 | Inputs From L2 and To L2 |
      | Inputs From L3 and To L3 |            |               |           |            | North Buona | Camborne Rd | 4.28       | 0.28 | 4.0         | 0            | 0      | 0           | OK       | uid:82c4e670-586c-449d-889a-3e7b205ee314 | Inputs From L3 and To L3 |
  ...
  Scenario Outline: Create and Check Script - Legacy Order Fields - <dataset_name> (<hiptest-uid>)
    ...
    Examples:
      ...
      | RETURN, EXPRESS  | RETURN, EXPRESS  | EXPRESS      | RETURN    | 9.416      | 0.616 | 8.8         | 0            | 0      | 0           | OK       | uid:05331f6c-c126-4874-bdf2-7c7bf4e3c858 |
      | NORMAL, STANDARD | NORMAL, STANDARD | STANDARD     | NORMAL    | 7.062      | 0.462 | 6.6         | 0            | 0      | 0           | OK       | uid:dd39a8d8-8437-4ba1-8dd1-c5dc0ccefda9 |
  ...
  Scenario Outline: Create and Check Script - New Order Fields - <dataset_name>(<hiptest-uid>)
    ...
    Examples:
      ...
      | Parcel, STANDARD                   | Parcel, STANDARD                   | STANDARD      | Parcel                    | 17.12      | 1.12  | 16          | 0            | 0      | 0           | OK       | uid:4a8e8d1f-a3f1-4684-a2b5-62b2f81776e5 |
      | Marketplace, EXPRESS               | Marketplace, EXPRESS               | EXPRESS       | Marketplace               | 23.54      | 1.54  | 22          | 0            | 0      | 0           | OK       | uid:d0e0d022-6ee5-4964-9e97-ca7c5be6090d |
      | Return, NEXTDAY                    | Return, NEXTDAY                    | NEXTDAY       | Return                    | 32.1       | 2.1   | 30          | 0            | 0      | 0           | OK       | uid:8718aa6b-c660-49a3-8736-491e5b6c3d69 |
      | Document, SAMEDAY                  | Document, SAMEDAY                  | SAMEDAY       | Document                  | 32.1       | 2.1   | 30          | 0            | 0      | 0           | OK       | uid:b6b2ba5a-a6b3-4da1-b912-46f446eccd4c |
      | Bulky, STANDARD                    | Bulky, STANDARD                    | STANDARD      | Bulky                     | 15.087     | 0.987 | 14.1        | 0            | 0      | 0           | OK       | uid:96a6e6b0-f0a0-436d-a201-d6c27b645400 |
      | International, EXPRESS             | International, EXPRESS             | EXPRESS       | International             | 20.544     | 1.344 | 19.2        | 0            | 0      | 0           | OK       | uid:ea0f7b2d-5e3b-4af5-8c6e-c9e94fe5637d |
      | Ninja Pack, NEXTDAY                | Ninja Pack, NEXTDAY                | NEXTDAY       | Ninja Pack                | 28.141     | 1.841 | 26.3        | 0            | 0      | 0           | OK       | uid:0a2605a8-b707-43b7-9650-0407b0197f9d |
      | Marketplace International, SAMEDAY | Marketplace International, SAMEDAY | SAMEDAY       | Marketplace International | 25.038     | 1.638 | 23.4        | 0            | 0      | 0           | OK       | uid:26d8083c-2829-432b-8f2d-99a4ff754ce2 |
      | Corporate, STANDARD                | Corporate, STANDARD                | STANDARD      | Corporate                 | 19.795     | 1.295 | 18.5        | 0            | 0      | 0           | OK       | uid:64d99231-93cf-4aa1-a13e-ab7e4b118c5f |
      | Corporate Return, EXPRESS          | Corporate Return, EXPRESS          | EXPRESS       | Corporate Return          | 25.252     | 1.652 | 23.6        | 0            | 0      | 0           | OK       | uid:c2651843-f068-4c89-91ff-117782f05e1d |
  ...
  Scenario Outline: Create and Check Script - Send is_RTS - Use calculate() - <dataset_name> (<hiptest-uid>)
    ...
    Examples:
      ...
      | RTS = True   | RTS = True  | Yes           | 1.07       | 0.07 | 1           | 0            | 0      | 0           | OK       | uid:2bf32cea-5fde-4844-9dde-f245abab7325 |
      | RTS = False  | RTS = False | No            | 1.07       | 0.07 | 1           | 0            | 0      | 0           | OK       | uid:514849a5-2457-443e-88e8-8eee1fea3970 |
