...
#    Then Operator verify the Draft Script is deleted successfully
  ...
  Scenario Outline: Create and Check Script with from_l1, from_l2, from_l3, to_l1, to_l2, to_l3
    ...
    Then Operator verify Draft Script is released successfully
    Examples:
      | Note                     | hiptest-uid                              | fromL1     | toL1          | fromL2    | toL2       | fromL3      | toL3        | grandTotal | gst  | deliveryFee | insuranceFee | codFee | handlingFee | comments |
      | Inputs from L1 and to L1 | uid:34d9484e-5a4a-4a35-90de-e519450ac0f1 | Holland Rd | University Rd |           |            |             |             | 2.14       | 0.14 | 2.0         | 0            | 0      | 0           | OK       |
      | Inputs From L2 and To L2 | uid:34d9484e-5a4a-4a35-90de-e519450ac0f1 |            |               | Dover Ave | Jln Bahasa |             |             | 3.21       | 0.21 | 3.0         | 0            | 0      | 0           | OK       |
      | Inputs From L3 and To L3 | uid:34d9484e-5a4a-4a35-90de-e519450ac0f1 |            |               |           |            | North Buona | Camborne Rd | 4.28       | 0.28 | 4.0         | 0            | 0      | 0           | OK       |
