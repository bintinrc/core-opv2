...
Feature: Pricing Scripts V2
  ...
  Scenario Outline: Create and Check Script with from_l1, from_l2, from_l3, to_l1, to_l2, to_l3
    ...
    Examples:
      | Note                     | isL1Exist | isL2Exist | isL3Exist | fromL1     | toL1          | fromL2    | toL2       | fromL3      | toL3        | grandTotal | gst  | deliveryFee | insuranceFee | codFee | handlingFee | comments |
      | Inputs from L1 and to L1 | Yes       | No        | No        | Holland Rd | University Rd |           |            |             |             | 2.14       | 0.14 | 2.0         | 0            | 0      | 0           | OK       |
      | Inputs From L2 and To L2 | No        | Yes       | No        |            |               | Dover Ave | Jln Bahasa |             |             | 3.21       | 0.21 | 3.0         | 0            | 0      | 0           | OK       |
      | Inputs From L3 and To L3 | No        | No        | Yes       |            |               |           |            | North Buona | Camborne Rd | 4.28       | 0.28 | 4.0         | 0            | 0      | 0           | OK       |
  ...
  Scenario Outline: Create and Check Script with Send is_RTS - Use calculatePricing()
    ...
    Examples:
      ...
      | RTS = True  | Yes           | 3.03       | 0.03 | 3           | 0            | 0      | 0           | OK       |
      | RTS = False | No            | 1.01       | 0.01 | 1           | 0            | 0      | 0           | OK       |
