...
Feature: Create Campaign
  ...
  Scenario: Create New Campaign - Input Long Campaign Name - More than 50 Characters (uid:2765d2a9-4df3-472b-b64e-9c2d9f27a86c)
    ...
    Then Operator enter campaign details using data below:
      | campaignName                            | campaignDescription | startDate                      | endDate                        | serviceType | serviceLevel | discountValue | discountUsageQuantityPerShipper | discountUsagePeriod  |
      | {campaign-name-more-than-50-characters} | dummy description   | {gradle-next-1-day-yyyy-MM-dd} | {gradle-next-2-day-yyyy-MM-dd} | Parcel;     | Standard;    | 5;            | Unlimited                       | Till end of campaign |
  ...
  Scenario: Create New Campaign - Empty Campaign Name (uid:1dd4d130-d4ba-41e5-b991-57b80c19e2f8)
    ...
    Then Operator enter campaign details using data below:
      | campaignName | campaignDescription | startDate                      | endDate                        | serviceType | serviceLevel | discountValue | discountUsageQuantityPerShipper | discountUsagePeriod  |
      |              | dummy description   | {gradle-next-1-day-yyyy-MM-dd} | {gradle-next-2-day-yyyy-MM-dd} | Parcel;     | Standard;    | 5;            | Unlimited                       | Till end of campaign |
    When Operator clicks on publish button
