...
Feature: Parcel Sweeper Live
  ...
  Scenario: [API] Order create - [API] Create route - [API] Success reservation - [OPV2] Global inbound update weight (skip auto resize) - [API] Add delivery to route - [API] Van inbound - [API] Success delivery
  ...
  @CloseNewWindows @DeleteOrArchiveRoute
  Scenario: [API] Order create - [API] Create route - [API] Success reservation - [OPV2] Global inbound update dimension (skip auto resize) - [API] Add delivery to route - [API] Van inbound - [API] Success delivery
    When API Operator create new shipper address V2 using data below:
      | shipperId       | {shipper-v4-id} |
      | generateAddress | RANDOM          |
    And API Operator create V2 reservation using data below:
  ...
  @CloseNewWindows @DeleteOrArchiveRoute
  Scenario: [API] Order create - [API] Create route - [API] Success reservation - [OPV2] Global inbound update dimension (Autosizing XL) - [API] Add delivery to route - [API] Van inbound - [API] Success delivery
    When API Operator create new shipper address V2 using data below:
      | shipperId       | {shipper-v4-id} |
      | generateAddress | RANDOM          |
    And API Operator create V2 reservation using data below:
