...
Feature: Parcel Sweeper Live
  ...
  Scenario: [API] Order create - [API] Create route - [API] Success reservation - [DWS] Global inbound update weight (Autosizing XS) - [API] Add delivery to route - [API] Van inbound - [API] Success delivery
