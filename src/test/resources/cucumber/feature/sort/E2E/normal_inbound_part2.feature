...
Feature: Parcel Sweeper Live
  ...
  Scenario: [API] Order create - [API] Create route - [API] Success reservation - [OPV2] Global inbound update weight (Autosizing M) - [API] Add delivery to route - [API] Van inbound - [API] Success delivery
