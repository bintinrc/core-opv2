...
Feature: Path Invalidation - With Trip
  ...
  @DeleteHubsViaAPI @DeleteHubsViaDb @DeleteShipments @DeleteDriver
  ...
  Scenario Outline: Update Hub Facility Type - Van Inbound w/ Trip - <name> - (<hiptest-uid>)
    ...
    Examples:
      ...
      | Crossdock to Crossdock                         | uid:3199582c-3eb0-4c72-b1a0-fb27b91753f7 | CD->CD                  |
      | Crossdock to its Station                       | uid:8ccefc09-f6d7-4016-b945-82b4508016be | CD->its ST              |
      | Crossdock to another Crossdock's Station       | uid:570fadaf-ed34-4f70-af21-d211b3f01121 | CD->ST under another CD |
      | Station to Station under the same Crossdock    | uid:39218116-db23-4266-825e-6f9456c3f210 | ST->ST under same CD    |
      | Station to Station under a different Crossdock | uid:fc72ce77-f150-49c4-9e4f-a4824646cb39 | ST->ST under diff CD    |
  ...
  Scenario Outline: Update Hub LatLong - Van Inbound w/ Trip - <name> - (<hiptest-uid>)
    ...
    Examples:
      | name                                           | hiptest-uid                              | type                    |
      | Crossdock to Crossdock                         | uid:fa5b0310-38a2-489f-9914-e18d523d1ebf | CD->CD                  |
      | Crossdock to its Station                       | uid:6a57c1ef-cf16-4c73-a0b0-bffeaff6274f | CD->its ST              |
      | Crossdock to another Crossdock's Station       | uid:02d51f9b-b7c3-4527-a902-53ba407005ed | CD->ST under another CD |
      | Station to Station under the same Crossdock    | uid:d71939f2-8245-4c9c-98a8-63ed504c329b | ST->ST under same CD    |
      | Station to Station under a different Crossdock | uid:812d3bb3-8e4f-41cd-ac56-4c2c29fc87f1 | ST->ST under diff CD    |
  ...
  Scenario Outline: Activate Hub - Van Inbound w/ Trip - <name> - (<hiptest-uid>)
    ...
    Examples:
      | name                                           | hiptest-uid                              | type                    |
      | Crossdock to Crossdock                         | uid:d822d773-d61f-4623-bdca-f56879a63814 | CD->CD                  |
      | Crossdock to its Station                       | uid:ce32c286-fb30-4308-9da3-04f75d90e60a | CD->its ST              |
      | Crossdock to another Crossdock's Station       | uid:be20ecaf-dfca-417c-8114-84355e3e0869 | CD->ST under another CD |
      | Station to Station under the same Crossdock    | uid:5924659b-806d-43fb-854c-08fd9b4414cd | ST->ST under same CD    |
      | Station to Station under a different Crossdock | uid:db4b4b48-7c74-42b0-8780-cd53f0083f11 | ST->ST under diff CD    |
  ...
  Scenario Outline: Update Schedule - Van Inbound w/ Trip - (<type>) - (<hiptest-uid>)
    ...
    Examples:
      | type                    | hiptest-uid                              |
      | CD->CD                  | uid:52443762-c03e-4779-864d-57bc3d5bc39c |
      | CD->its ST              | uid:1b378bd2-5ba1-4267-b1be-93c3fa44e46d |
      | CD->ST under another CD | uid:34ed9af1-618b-4bd7-a288-f3e92801e8d3 |
      | ST->ST under same CD    | uid:efc92644-cee9-4333-bdd7-1fe6ca2a482f |
      | ST->ST under diff CD    | uid:9bdf6347-cf8a-4838-be33-2e7901e89af4 |
