...
Feature: Path Invalidation - With Trip
  ...
  @DeleteHubsViaAPI @DeleteShipments @DeleteDriverV2 @DeleteHubsViaDb @DeletePaths
  ...
  Scenario Outline: Create Schedule - Van Inbound w/ Trip - <dataset_name> (<hiptest-uid>)
    ...
    Examples:
      ...
      | CD->its ST              | uid:23c96087-4936-48ad-a51c-00e7d2a1b5ab | CD->its ST               |
      | CD->ST under another CD | uid:d747a8b6-096f-4f5b-8fdd-e475d8859c42 | CD->ST under another CD  |
      | ST->ST under same CD    | uid:9405c9a4-7a01-4666-8437-14b624b5d60b | ST->ST under same CD     |
      | ST->ST under diff CD    | uid:4b6b06f4-95c3-4fc2-b9ae-69f84f0c8527 | ST->ST under diff CD     |
      | ST->its CD              | uid:f4d92967-25df-42d9-b0fe-6943140df265 | ST->its CD               |
      | ST->another CD          | uid:30e1fe63-c920-43db-8838-23f60ef5f0b5 | ST->another CD           |
  ...
  Scenario Outline: Update Schedule - Van Inbound w/ Trip - <dataset_name> (<hiptest-uid>)
    ...
    Examples:
      | type                    | hiptest-uid                              | dataset_name             |
      | CD->CD                  | uid:8fe30856-ab34-41b5-b9b0-865ad2e5dfe5 | CD->CD                   |
      | CD->its ST              | uid:bd46bca6-411e-483a-9fda-8e12b5c69947 | CD->its ST               |
      | CD->ST under another CD | uid:60d5a956-ed3c-4dd5-a788-622f5f0fda12 | CD->ST under another CD  |
      | ST->ST under same CD    | uid:5f617c12-31d0-4859-88f8-e5af037c5f97 | ST->ST under same CD     |
      | ST->ST under diff CD    | uid:fbff044e-eb5d-4133-8aeb-29f096780385 | ST->ST under diff CD     |
      | ST->its CD              | uid:0cb2af56-3c14-4e98-92d3-f26161167f71 | ST->its CD               |
      | ST->another CD          | uid:f0bf3668-5740-4fa5-8658-457a23fa4687 | ST->another CD           |
  ...
  Scenario Outline: Delete Schedule - Van Inbound w/ Trip - <dataset_name> (<hiptest-uid>)
    ...
    Examples:
      | type                    | hiptest-uid                              | dataset_name             |
      | CD->CD                  | uid:15ba9100-2e9e-4251-ba2b-7da197f5767d | CD->CD                   |
      | CD->its ST              | uid:76d240e4-1985-4265-83c8-c1bb36d225c5 | CD->its ST               |
      | CD->ST under another CD | uid:ef51feaa-a2b6-492b-99ad-5bd5fac3fe54 | CD->ST under another CD  |
      | ST->ST under same CD    | uid:0995cf18-4177-46bf-bb2f-3e91836e55c8 | ST->ST under same CD     |
      | ST->ST under diff CD    | uid:ff8af3c5-b57f-44c3-84ab-d557ddaa9009 | ST->ST under diff CD     |
      | ST->its CD              | uid:fc0fee7b-b7a4-4781-8eb0-666c00c1cdcf | ST->its CD               |
      | ST->another CD          | uid:e9f964f4-b2c8-4ba4-bcac-98957b35c949 | ST->another CD           |
  ...
  Scenario Outline: Update Hub Facility Type - Van Inbound w/ Trip - <dataset_name> (<hiptest-uid>)
    ...
    Examples:
      ...
      | Crossdock to Crossdock                         | uid:d3ee340d-e0aa-4a53-8aee-b2b79ebb8a8f | CD->CD                  | Crossdock to Crossdock                          |
      | Crossdock to its Station                       | uid:58bb6ce8-36ef-4628-a0e0-e3a8e3b3091f | CD->its ST              | Crossdock to its Station                        |
      | Crossdock to another Crossdock's Station       | uid:d9f1f670-ce98-4c5f-b9d0-656a879694b2 | CD->ST under another CD | Crossdock to another Crossdock's Station        |
      | Station to Station under the same Crossdock    | uid:afb31544-1328-406b-aef7-1995928c3364 | ST->ST under same CD    | Station to Station under the same Crossdock     |
      | Station to Station under a different Crossdock | uid:234fa38b-223e-4f83-8bb4-92955b71acaa | ST->ST under diff CD    | Station to Station under a different Crossdock  |
      | Station to its Crossdock                       | uid:59eaf7f5-eb64-45f1-be05-53ef33709a79 | ST->its CD              | Station to its Crossdock                        |
      | Station to different Crossdock                 | uid:8182c2b2-2f65-4c7a-9beb-9356c3330429 | ST->another CD          | Station to different Crossdock                  |
  ...
  Scenario Outline: Update Hub LatLong - Van Inbound w/ Trip - <dataset_name> (<hiptest-uid>)
    ...
    Examples:
      | name                                           | hiptest-uid                              | type                    | dataset_name                                    |
      | Crossdock to Crossdock                         | uid:809cb8eb-15ec-4cf7-9ef1-134173100772 | CD->CD                  | Crossdock to Crossdock                          |
      | Crossdock to its Station                       | uid:e1069cc8-ca2f-4016-8128-b999286655b6 | CD->its ST              | Crossdock to its Station                        |
      | Crossdock to another Crossdock's Station       | uid:72d24634-75ed-4114-977d-cf6bcd6ae168 | CD->ST under another CD | Crossdock to another Crossdock's Station        |
      | Station to Station under the same Crossdock    | uid:d42272d1-3ea4-4c25-90a7-40c094edaf29 | ST->ST under same CD    | Station to Station under the same Crossdock     |
      | Station to Station under a different Crossdock | uid:9d6fe333-17e1-452f-beb6-c1af7a398623 | ST->ST under diff CD    | Station to Station under a different Crossdock  |
      | Station to its Crossdock                       | uid:920fd545-4fc0-4549-8fd4-9b42bbf10c7e | ST->its CD              | Station to its Crossdock                        |
      | Station to different Crossdock                 | uid:52ebbf20-c974-4f52-bba5-d8931ff0d84b | ST->another CD          | Station to different Crossdock                  |
