@OperatorV2 @MiddleMile @Hub @AccessControl @SortAppUserManagement @CFW
Feature: Sort App User Management
  ...
  Scenario: Cannot Create Duplicate Sort App User (uid:bc5a1f23-0b6e-4fb8-948e-0dbc3638ad91)
  ...
  Scenario Outline: Cannot Create Sort App User with Invalid Request - <scenarioName> (<hiptest-uid>)
    Given Operator go to menu Shipper Support -> Blocked Dates
    Given Operator go to menu Access Control -> Sort App User Management
    ...
    Examples:
      | scenarioName                   | errorMessage                      | firstName | username | password | employmentType | employmentStartDate | primaryHub | position | hiptest-uid                              |
  ...
  Scenario: Search Sort App User (uid:b20f29ed-adbe-45ee-a4f6-97caf3059b5a)
    Given Operator go to menu Shipper Support -> Blocked Dates
    Given Operator go to menu Access Control -> Sort App User Management
    When Operator create new Sort App User with details:
      | firstName | lastName   | contact        | username | password | employmentType | primaryHub | warehouseTeamFormation | position | comments                                                             |
  ...
  @DeleteSortAppUser
  Scenario Outline: Search Sort App User by Filter - <scenarioName> (<hiptest-uid>)
    Given Operator go to menu Shipper Support -> Blocked Dates
    Given Operator go to menu Access Control -> Sort App User Management
    When Operator create new Sort App User with details:
      | firstName | lastName   | contact        | username | password | employmentType | primaryHub | warehouseTeamFormation | position | comments                                                             |
  ...
  Scenario Outline: Update Personal Detail - <scenarioName> (<hiptest-uid>)
    ...
    Then Operator verifies that the newly created Sort App User will be shown
    Examples:
      | scenarioName            | firstName  | lastName   | contact                       | password   | employmentType | employmentStatus | primaryHub | warehouseTeamFormation | position | comments                                                             | hiptest-uid                              |
