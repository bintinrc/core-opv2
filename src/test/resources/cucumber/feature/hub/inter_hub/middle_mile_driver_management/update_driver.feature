...
Feature: Middle Mile Driver Management - Update Driver
  ...
  Scenario: Update Employment Details - Employment End Date (uid:e2b5d826-6669-46f0-8a08-b8e00dd6c51f)
    ...
    Then DB Operator verifies driver "employmentEndDate" with username "{KEY_MM_LIST_OF_CREATED_MIDDLE_MILE_DRIVERS[1].username}" and value "{gradle-next-3-day-yyyy-MM-dd}" is updated
