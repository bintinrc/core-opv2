@OperatorV2 @MiddleMile @Hub @InterHub @PortTripManagement @CompleteToFromPortTrip
Feature: Airport Trip Management - Complete To From Airport Trip
  ...
  Scenario: Complete Warehouse to Airport Trip
    ...
    When Operator completes trip "{KEY_LIST_OF_CURRENT_MOVEMENT_TRIP_IDS[1]}" on Port Trip Management page
