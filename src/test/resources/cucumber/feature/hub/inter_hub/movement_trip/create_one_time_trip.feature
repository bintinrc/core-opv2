@OperatorV2 @MiddleMile @Hub @InterHub @MovementTrip @CreateOneTimeTrip @CWF
...
#    And Operator refresh page
    ...
    And Operator create One Time Trip on Movement Trips page using data below:
      ...
      | assignDrivers     | 4                                           |
#    When Operator searches and selects the "one time trip origin hub" with value "{KEY_LIST_OF_CREATED_HUBS[1].name}"
#    And Operator searches and selects the "one time trip destination hub" with value "{KEY_LIST_OF_CREATED_HUBS[2].name}"
#    And Operator searches and selects the "one time trip movement type" with value "Land Haul"
