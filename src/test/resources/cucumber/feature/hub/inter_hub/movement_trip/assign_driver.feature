...
Feature: Movement Trip - Assign Driver
  ...
  @DeleteHubsViaDb @DeleteMiddleMileDriver @DeleteCreatedMovementSchedules @henlo
  Scenario: Assign Single Driver to Movement Trips (uid:4cf35840-44dd-4573-bdb1-a51ac7f58984)
    ...
    When API MM - Create "LAND_HAUL" Movement Schedule from "{KEY_LIST_OF_CREATED_HUBS[1].id}" to "{hub-relation-destination-hub-id}" with data below:
