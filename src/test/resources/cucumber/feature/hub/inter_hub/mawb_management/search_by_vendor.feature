...
Feature: MAWB Management - Search by Vendor
  ...
  @DeleteShipments @DeleteCreatedAirports @DeleteAirportsViaAPI
...
#    And API Operator refresh Airports cache
    Given API Operator create new air trip with data below:
      ...
      | originFacility      | {airport-id-1}                |
      | destinationFacility | {airport-id-2}                |
      | flight_no           | 12345                         |
    ...
    Given Operator searchs by vendor following data below on MAWB Management page:
      | mawbVendor              | {vendor-id}                    |
      | mawbOriginAirport       | {airport-id-1}                 |
      | mawbDestinationAirport  | {airport-id-2}                 |
