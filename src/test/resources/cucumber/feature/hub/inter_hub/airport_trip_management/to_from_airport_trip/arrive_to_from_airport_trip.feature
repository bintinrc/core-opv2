@OperatorV2 @MiddleMile @Hub @InterHub @AirportTripManagement @ArriveToFromAirportTrip
Feature: Airport Trip Management - Arrive To From Airport Trip
  ...
  Scenario: Arrive Warehouse to Airport Trip
    ...
    Then Operator verifies trip message "Trip {KEY_LIST_OF_CURRENT_MOVEMENT_TRIP_IDS[1]} arrived" display on Airport Trip Management page
    And Operator verifies "COMPLETE" button is shown on Airport Trip Management page
  ...
  Scenario: Arrive Airport to Airport Trip
    ...
    Then Verify the parameters of loaded trips in Airport Management
      ...
      | originOrDestination | {KEY_CREATED_AIRPORT_LIST[1].airport_code} (Airport)|
    When Operator arrives trip "{KEY_LIST_OF_CURRENT_MOVEMENT_TRIP_IDS[1]}" on Airport Trip Management page
    Then Operator verifies trip message "Trip {KEY_LIST_OF_CURRENT_MOVEMENT_TRIP_IDS[1]} has completed" display on Airport Trip Management page
    And Operator verifies "COMPLETED" button is shown on Airport Trip Management page
