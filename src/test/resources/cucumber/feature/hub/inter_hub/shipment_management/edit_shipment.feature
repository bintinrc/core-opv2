...
#    Then Operator verify parameters of the created shipment on Shipment Management page
  ...
  Scenario: Edit Shipment - End Hub (uid:2a179fc7-9139-455d-b1a2-d4e5582c88a7)
    Given no-op

  Scenario: Edit Shipment - Comments (uid:af9bb414-10d0-4dc6-a298-189e2884c63f)
    Given no-op

  Scenario: Edit Shipment - EDA & ETA (uid:380aee44-c3e6-4a81-9fb7-9e77b01259cd)
    Given no-op
